...
Always enabled regardless of `server-role`. It's utility behavior, never named in the hub-behavior default-off list, and required to keep working even when SwagCore is also installed.
